...
var _user$project$MuliklikPlayer$main = {
	main: _elm_lang$html$Html$text('Hello world')
};

var Elm = {};
Elm['MuliklikPlayer'] = Elm['MuliklikPlayer'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['MuliklikPlayer'], 'MuliklikPlayer', typeof _user$project$MuliklikPlayer$main === 'undefined' ? null : _user$project$MuliklikPlayer$main);
